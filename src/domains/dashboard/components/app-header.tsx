...
export default function AppHeader({ pathname, setMobileOpen, setSearchOpen }: AppHeaderProps) {
    ...
    // 1. Dynamic Scroll Effect: Header gets more "solid" as you scroll
    React.useEffect(() => {
    ...
    return (
        <header className={cn(
            ...
            // Premium Glassmorphism: Changes based on scroll position
            isScrolled
            ...
            <div className="flex items-center gap-4 flex-1 min-w-0">
                {/* 2. Interactive Breadcrumbs Container */}
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-56 p-2 rounded-2xl shadow-2xl border-border/40 bg-popover/95 backdrop-blur-md">
                        ...
                        <DropdownMenuItem className="flex items-center gap-3 p-2.5 rounded-xl cursor-pointer">
                            ...
                            <div className="flex flex-col"><span className="text-sm font-medium">New Movie</span><span className="text-[10px] text-muted-foreground">Upload content</span></div>
                        </DropdownMenuItem>
                        <DropdownMenuItem className="flex items-center gap-3 p-2.5 rounded-xl cursor-pointer">
                            <div className="bg-purple-500/10 p-2 rounded-lg"><LayoutGrid className="w-4 h-4 text-purple-500" /></div>
                            <div className="flex flex-col"><span className="text-sm font-medium">New Series</span><span className="text-[10px] text-muted-foreground">Add a season</span></div>
                        </DropdownMenuItem>
                        <DropdownMenuItem className="flex items-center gap-3 p-2.5 rounded-xl cursor-pointer">
                            <div className="bg-emerald-500/10 p-2 rounded-lg"><Users className="w-4 h-4 text-emerald-500" /></div>
                            <div className="flex flex-col"><span className="text-sm font-medium">New Staff</span><span className="text-[10px] text-muted-foreground">Grant permissions</span></div>
                        </DropdownMenuItem>
                    </DropdownMenuContent>
                </DropdownMenu>
