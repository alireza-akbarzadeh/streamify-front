...
import { AlbumsSection, ArtistHero, FeaturedVideo, RelatedArtists, TopSongs } from "./components";
...
export function ArtistProfile() {
    ...
    const artist = {
        ...
        country: "Canada",
        bio: {
            short: "Abel Tesfaye, known professionally as The Weeknd, is a Canadian singer, songwriter, and record producer.",
    ...
    const topSongs = [
        ...
        },
        {
            ...
            duration: "3:50",
            album: "Starboy",
            albumArt: "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=300&q=80",
            isExplicit: true
        },
        {
            id: 3,
