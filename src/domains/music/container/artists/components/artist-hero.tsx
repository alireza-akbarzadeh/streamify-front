...
import { BadgeCheck, MapPin, MoreHorizontal, Play, Share2, UserCheck, UserPlus } from 'lucide-react';
                ...
                <div className="max-w-[1800px] mx-auto px-6 w-full">
                    <div className="max-w-3xl">
                        ...
                        <motion.h1
                            ...
                            style={{
                                textShadow: '0 4px 30px rgba(0,0,0,0.8), 0 0 60px rgba(139, 92, 246, 0.4)'
                            }}
                        >
                            {artist.name}
                        </motion.h1>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-xl font-semibold text-purple-400">{artist.monthlyListeners}</span>
                        ...
                        >
                            {/* Play button */}
                            <Button
                                className="h-14 px-8 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white rounded-full font-bold text-lg group shadow-2xl shadow-purple-500/40"
                            >
