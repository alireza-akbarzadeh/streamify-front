...
import {
    CheckCircle, ChevronRight, Clock, DollarSign, Facebook, Globe,
    Headphones, Instagram, Linkedin,
    Mail, MapPin, MessageCircle, Phone, Send, Shield,
    Twitter, Users, Youtube, Zap
} from 'lucide-react';
    ...
    const faqs = [
        {
            ...
            answer: 'We aim to respond to all inquiries within 24 hours. Premium members receive priority support with response times under 1 hour.'
        },
        {
            question: 'Can I track my support ticket?',
            answer: 'Yes! After submitting a ticket, you will receive a confirmation email with a tracking number and status updates.'
        },
        {
            question: 'Do you offer phone support?',
            answer: 'Phone support is available Monday-Friday, 9am-6pm EST. Live chat is available 24/7 for immediate assistance.'
        },
        {
                ...
                <div className="relative max-w-5xl mx-auto px-6 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
                            We are here to help. Choose how you would like to reach us and we will get back to you as soon as possible.
                        </p>
                    </motion.div>
                </div>
            </section>
                            ...
                            {isSubmitted ? (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <SelectContent className="bg-[#1a1a1a] border-white/10">
                                                <SelectItem value="support" className="text-white hover:bg-white/10">General Support</SelectItem>
                                                <SelectItem value="billing" className="text-white hover:bg-white/10">Billing & Payments</SelectItem>
                                                <SelectItem value="technical" className="text-white hover:bg-white/10">Technical Issue</SelectItem>
                                                <SelectItem value="business" className="text-white hover:bg-white/10">Business Inquiry</SelectItem>
                                    ...
                                    <Button
                                        ...
                                        className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white py-6 text-lg rounded-xl"
                                    >
                                        {isSubmitting ? (
                                            <>
                            ...
                            >
                                ...
                                <div className="space-y-2 text-gray-400">
                                    <div className="flex items-start gap-2">
                                        <MapPin className="w-5 h-5 flex-shrink-0 text-purple-400" />
                                        <div>
                                            <p>{office.address}</p>
                                            <p>{office.postal}</p>
                                        </div>
