            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-600/20 border border-purple-600/30 mb-6">
                        ...
                        <span className="text-sm font-medium text-purple-400">Latest Version: 2.5.0</span>
                    </div>
                </motion.div>
                ...
                >
                    Your ultimate entertainment platform. Stream music, movies, and more on any device, anywhere.
                </motion.p>
