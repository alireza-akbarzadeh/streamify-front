            ...
            <div className="relative z-10">
                ...
                <div className="max-w-7xl mx-auto px-6 pb-20">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 leading-relaxed">
                                    All downloads are verified and signed. Your privacy and security are our top priority.
                                    Every release is scanned for malware and comes with automatic updates to keep you protected.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        >
                            <span className="text-sm font-medium">View Release Notes & What's New</span>
