            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
                    {related.map((item, index) => {
                        const ratingStyle = RATING_CONFIG[item.rating as Rating] || RATING_CONFIG["Interesting"];
                            ...
                            >
                                ...
                                <div className="px-2">
                                    <div className="flex items-center justify-between mb-3">
                                        ...
                                        <div className={`flex items-center gap-1.5 px-2 py-1 rounded-full border ${ratingStyle.bg}`}>
                                            <span className="text-[10px]">{ratingStyle.emoji}</span>
                                            <span className={`text-[8px] font-black uppercase tracking-widest ${ratingStyle.color}`}>
                                                {item.rating}
                                            </span>
                                        </div>
