...
export function PlanCard({
  ...
  const hasSubscription = userSubscription?.status !== "FREE" && userSubscription?.status !== "NONE" && userSubscription?.currentPlan;
  ...
  return (
    ...
    >
      ...
      <Card
        className={`relative overflow-hidden bg-white/3 backdrop-blur-xl border p-8 h-full transition-all duration-300 ${isCurrentPlan
        ...
        <div className="relative">
              ...
              <motion.div whileTap={{ scale: 0.98 }}>
                <Button
                  ...
                  className={`w-full ${plan.popular
                    ...
                    } text-white font-semibold py-6 rounded-xl transition-all duration-300 ${isActive ? "shadow-lg shadow-purple-500/20" : ""
          ...
          <div className="space-y-4">
            {plan.features.map((feature, i) => (
              ...
              >
                <div
                  className={`p-1 rounded-full bg-linear-to-br ${isCurrentPlan ? "from-green-600 to-emerald-600" : plan.gradient
