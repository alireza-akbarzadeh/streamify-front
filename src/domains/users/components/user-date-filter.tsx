...
import { Calendar as CalendarIcon, Database, RotateCcw, Zap } from "lucide-react";
...
export function UserDateFilter({ onApply, currentFilters }: UserDateFilterProps) {
    ...
    return (
        <div className="space-y-8 py-6">
            ...
            <div className="pt-6 border-t border-border/40 flex flex-col gap-2">
                ...
                <Button
                    variant="ghost"
                    onClick={() => { setDate(undefined); onApply([]); }}
