    ...
    return (
        <div className="grid grid-cols-2 gap-2 p-1">
            <AppDialog
                ...
                trigger={
                    <Button variant="outline" className="h-auto py-2.5 flex-col gap-1.5 text-[10px] rounded-xl group transition-all">
            ...
            >
                <div className="space-y-6">
                    ...
                    <Button
                        ...
                        onClick={() => navigate({ to: `/dashboard/users/$userId`, params: { userId: user.id } })}
                    >
