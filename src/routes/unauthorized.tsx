            ...
            <div className="text-center py-6 space-y-6">
                ...
                <div className="space-y-2">
                    <h1 className="text-2xl font-bold text-white">
                        {error === 'unauthorized' ? 'Unauthorized Access' : 'Permission Denied'}
                    </h1>

                    <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4 mt-4">
                        <p className="text-gray-300 text-sm">
                            {error === 'unauthorized' ? (
                                <>This area requires <span className="text-red-400 font-semibold">{requiredRole}</span> privileges.</>
                            ) : (
                ...
                <div className="space-y-3 pt-4">
                    <Link
                        ...
                        className={buttonVariants({
                            className: "w-full h-12 bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white border-0"
                        })}
                    >
